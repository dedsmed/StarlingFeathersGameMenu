package game.feathersUI.pages {
	 ...
	 * @author Alex
	 */
	public class DebugPage extends AMenuPage {
		...
		public function DebugPage(titleText:String = "") { super(titleText); }
		...
		override protected function drawPage():void {
			...
			// [============[ Button ]============]
			button1 = addButton("ClearSharedObject", "Clear SharedObject", function(e:Event):void 
				{ settingChangedSignal.dispatch("ClearSharedObject", true , false); } );
				
			button2 = addButton("EndLevel", "End Level", function(e:Event):void 
				{ settingChangedSignal.dispatch("EndLevel", true , false); } );
				
			button3 = addButton("RestartLevel", "Restart Level", function(e:Event):void 
				{ settingChangedSignal.dispatch("RestartLevel", true , false); });
			
			// [============[ Checkbox ]============]
			check1 = addCheckbox("ShowBox2DDebugArt", "Show Box2D Debug Art", function(e:Event):void 
				{ settingChangedSignal.dispatch("ShowBox2DDebugArt", Check(e.currentTarget).isSelected, false); }, true);
			...
			if (toggle1) addTextLabel("Enable Extra Blood", toggle1.x + toggle1.width + pad, toggle1.y + 5);
		}
		...
		private function addToggleSwitch(name:String, handler:Function = null, value:Boolean = false):ToggleSwitch {
			...
			toggleSwitch.thumbProperties = { height: 48 };
